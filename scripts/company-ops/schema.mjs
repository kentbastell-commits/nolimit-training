        ...
        },
        {
          ...
          forms: [
            form(
              ...
              ["活动 Campaign", "目标 Objective", "目标受众 Target Audience", "核心卖点 Offer", "产品 Product", "渠道 Channels", "预算 Budget", "开始 Start", "结束 End", "负责人 Owner", "需要决策 Decision Needed"],
              ["活动 Campaign", "目标 Objective", "目标受众 Target Audience", "产品 Product", "渠道 Channels", "预算 Budget", "开始 Start", "结束 End", "负责人 Owner"],
            ),
          ],
        },
        {
