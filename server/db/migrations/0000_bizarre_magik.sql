...
ALTER TABLE "clients" ADD CONSTRAINT "clients_primary_coach_id_coaches_coach_id_fk" FOREIGN KEY ("primary_coach_id") REFERENCES "public"."coaches"("coach_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "clients" ADD CONSTRAINT "clients_secondary_coach_id_coaches_coach_id_fk" FOREIGN KEY ("secondary_coach_id") REFERENCES "public"."coaches"("coach_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "programs" ADD CONSTRAINT "programs_coach_id_coaches_coach_id_fk" FOREIGN KEY ("coach_id") REFERENCES "public"."coaches"("coach_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
