...
function buildLibraryDetail(e?: ExRow) {
  return {
    ...
    equipmentCn: str(e?.equipmentCn),
    movementPattern: str(e?.movementPattern),
    movementPatternCn: str(e?.movementPatternCn),
    ...
    cueNotesCn: str(e?.coachingCuesCn) || str(e?.technicalCuesCn),
  ...
  return templates
    .map((t): WorkoutDetailDTO => {
      ...
      return {
        ...
        sessionGoalCn: str(t.sessionGoalCn),
        sessionNotes: str(t.sessionNotes),
        sessionNotesCn: str(t.sessionNotesCn),
