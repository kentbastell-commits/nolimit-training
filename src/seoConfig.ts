...
const copy = {
  ...
  store: {
    ...
    zh: [
      "双语数字训练计划｜NX LIMIT Training",
      "浏览由专业教练编排的双语数字训练计划，包含引导式训练、动作视频与系统化进阶安排。",
    ],
  },
  coaching: {
    en: [
      "1:1 Online Coaching | NX LIMIT Training",
      "Personalised programming, weekly check-ins, technique review and direct bilingual coaching for committed athletes.",
    ],
    zh: [
      "一对一线上训练指导｜NX LIMIT Training",
      "为认真训练的运动员提供个性化计划、每周复盘、动作点评与中英文直接指导。",
    ],
  },
  inperson: {
    en: [
      "In-Person Training & Consulting | NX LIMIT Training",
      "Enquire about in-person athlete training, team support, performance planning, workshops and consulting.",
    ],
    zh: [
      "线下训练与体育咨询｜NX LIMIT Training",
      "咨询运动员线下训练、团队支持、运动表现规划、讲座及体育咨询服务。",
    ],
  },
  privacy: {
    en: ["Privacy Policy | NX LIMIT Training", "How NX LIMIT Training collects, uses, stores and protects personal and training information."],
    zh: ["隐私政策｜NX LIMIT Training", "了解 NX LIMIT Training 如何收集、使用、存储和保护个人信息与训练信息。"],
  },
  terms: {
    en: ["Terms of Service | NX LIMIT Training", "Terms governing NX LIMIT Training digital programs, coaching services, payments and safe participation."],
    zh: ["服务条款｜NX LIMIT Training", "适用于 NX LIMIT Training 数字训练计划、教练服务、付款及安全参与的服务条款。"],
  },
  refund: {
    en: ["Refund Policy | NX LIMIT Training", "NX LIMIT Training cancellation, digital-program and one-to-one coaching refund policy."],
    zh: ["退款政策｜NX LIMIT Training", "NX LIMIT Training 关于取消、数字训练计划及一对一指导的退款政策。"],
  },
  business: {
...
function pageCopy(key: CopyKey, language: SeoLanguage) {
  ...
  return [
    `${copy[key].en[0]} · ${copy[key].zh[0].replace("｜NX LIMIT Training", "")}`,
