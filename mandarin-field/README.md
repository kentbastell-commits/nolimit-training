...
The production build is an installable, offline-first web app. It includes 24 lessons, 15 graded stories, 15 role-plays, 16 character families, and 96 spaced-review cards in the application bundle.
